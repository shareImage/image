...
![image.png](https://cdn.jsdelivr.net/gh/shareImage/image@_md2zhihu_blog_cee8f3b4/就是要你懂TCP--通过案例来学习MSS、MTU/23df36d95295c839-23df36d95295c839722627b5d63bac48.png)

一般终端只有收到PATH MTU 调整报文才会去调整mss报文大小，PATH MTU是封装在ICMP报文里面。所以重新在ECS上抓包，抓取数据交互报文和ICMP报文。

![image-20221125133218008](https://cdn.jsdelivr.net/gh/shareImage/image@_md2zhihu_blog_cee8f3b4/就是要你懂TCP--通过案例来学习MSS、MTU/c9ac44a25a31a704-image-20221125133218008.png)
